...
float generateRandomSpeed(float base, float range) {
    return base + (((float)rand() / (0x7fff)) * 2.0f * range - range);
}
...
void main(void) {
    ...
    while (1) {
        ...
        raw_hum = I2C2_Read1ByteRegister(0x27, 0x00);
        raw_temp = I2C2_Read1ByteRegister(0b1001100, 0x00);
